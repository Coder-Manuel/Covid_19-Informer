...
class _GlobalCaseContainerState extends State<GlobalCaseContainer> {
  ...
  void updateRadialDial() {
    if (_caseType == CaseType.ACTIVE) {
      radialStartClr = Colors.blueAccent[700];
      radialEndClr = Colors.blueAccent[700];
      radialBgClr = Color(0xffd0d8f7);
      progress =
  ...
  void updateCasesPanel() {
    if (_caseType == CaseType.ACTIVE) {
      panelFontClr = Colors.blue;
      panelStartClr = Color(0xffd0d8f7);
      panelIconClr = Colors.blue;
      panelLineClr = Colors.blue;
    } else if (_caseType == CaseType.DEATHS) {
